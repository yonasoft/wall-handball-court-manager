...
class ReturnToRegularQueueFragmentDialogFragment:DialogFragment() {
    ...
    override fun onCreateView(
        ...
        binding!!.apply {
            ...
            if(args.players[0]!="TBA") checkboxT1p1.text=args.players[0] else binding!!.checkboxT1p1.visibility=View.GONE
            if(args.players[1]!="TBA") checkboxT1p2.text=args.players[1] else binding!!.checkboxT1p2.visibility=View.GONE
